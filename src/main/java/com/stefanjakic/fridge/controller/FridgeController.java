...
import com.stefanjakic.fridge.dto.CreateFridgeRequest;
...
import com.stefanjakic.fridge.dto.GiveItemsRequest;
        ...
        try {
            ...
            return ResponseEntity.ok(
                fridgeService.getMyUsersFromFridge(fridgeId, user).stream()
                    .map(u -> new com.stefanjakic.fridge.dto.UserDto(u.getId(), u.getEmail(), u.getRole()))
